...
class _$Thumbnails extends Thumbnails {
  ...
  _$Thumbnails._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(default_, 'Thumbnails', 'default_');
    BuiltValueNullFieldError.checkNotNull(medium, 'Thumbnails', 'medium');
    BuiltValueNullFieldError.checkNotNull(high, 'Thumbnails', 'high');
  }
